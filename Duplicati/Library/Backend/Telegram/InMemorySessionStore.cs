...
{
    public class InMemorySessionStore : IExtendedSessionStore
    {
        private readonly Dictionary<string, byte[]> m_phoneSessionBytesMap = new Dictionary<string, byte[]>();
        private readonly Dictionary<string, string> m_phonePhoneCodeHashMap = new Dictionary<string, string>();
